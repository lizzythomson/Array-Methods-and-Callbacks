...
const getWinners = function () {
  return getFinals(fifaData).map((match) =>
...
describe("getFinals", () => {
  it("getFinals returns an array of final matches", () => {
    expect(functions.getFinals(fifaData)).toEqual(
...
describe("getYears", () => {
  it("an array containing years", () => {
    expect(functions.getYears(fifaData, getFinals)).toEqual(
      expect.arrayContaining([
...
describe("getWinners", () => {
  it("an array containing all winners", () => {
    expect(functions.getWinners(fifaData, getFinals)).toEqual(
      expect.arrayContaining([
        "Uruguay",
        "Italy",
        "Italy",
...
describe("getWinnersByYear", () => {
  it("an array containing strings of winners", () => {
    expect(
      functions.getWinnersByYear(fifaData, getFinals, getYears, getWinners)
    ).toEqual(
      expect.arrayContaining([
